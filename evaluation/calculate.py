...
def calculate_breakdown(file_path) -> tuple:
    ...
    false_positives_omni_new = df_omni_new[((df_omni_new['equivalent'] == 'False') | (df_omni_new['equivalent'] == False)) & (df_omni_new['res'] == 'correct')]
    ...
    print(f"Final EX Score: {final_ex_score:.8%}")
